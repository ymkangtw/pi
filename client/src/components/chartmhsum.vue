...
const renderChart = (memberkpi) => {
    ...
    //});
    let sum_all = rdata.accu_genmh + rdata.accu_approvalmh + rdata.accu_dcsmh + rdata.accu_plcmh + rdata.accu_commh;
        ...
        series: [
            {
                ...
                //data: series_data,
                data: [
                    { value: rdata.accu_genmh, name: '自設' },
                    { value: rdata.accu_approvalmh, name: '審查' },
                    { value: rdata.accu_dcsmh, name: 'DCS' },
                    { value: rdata.accu_plcmh, name: 'PLC' },
                    { value: rdata.accu_commh, name: '試車' },
                ],
                label: {
                    show: false,
                    position: 'center'
